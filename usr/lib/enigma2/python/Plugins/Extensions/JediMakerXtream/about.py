...
class JediMakerXtream_About(Screen):
    ...
    def createSetup(self):
        self.credit = 'JediMakerXtream V4.19 (C) 2018/2019 - KiddaC\n\n'
        ...
        self.credit += "You can donate to my redbull, cigs and stress fund here. Thank you. https://paypal.me/kiddac \n"
        self.credit += 'Cheers'
